...
CREATE OR REPLACE FUNCTION apolloconfig.update_modified_column() RETURNS TRIGGER AS $$
BEGIN
...
CREATE TRIGGER "App_update_DataChange_LastTime" BEFORE UPDATE ON apolloconfig."App" FOR EACH ROW EXECUTE PROCEDURE apolloconfig.update_modified_column();
...
CREATE TRIGGER "AppNamespace_update_DataChange_LastTime" BEFORE UPDATE ON apolloconfig."AppNamespace" FOR EACH ROW EXECUTE PROCEDURE apolloconfig.update_modified_column();
...
CREATE TRIGGER "Audit_update_DataChange_LastTime" BEFORE UPDATE ON apolloconfig."Audit" FOR EACH ROW EXECUTE PROCEDURE apolloconfig.update_modified_column();
...
CREATE TRIGGER "Cluster_update_DataChange_LastTime" BEFORE UPDATE ON apolloconfig."Cluster" FOR EACH ROW EXECUTE PROCEDURE apolloconfig.update_modified_column();
...
CREATE TRIGGER "Commit_update_DataChange_LastTime" BEFORE UPDATE ON apolloconfig."Commit" FOR EACH ROW EXECUTE PROCEDURE apolloconfig.update_modified_column();
...
CREATE TRIGGER "GrayReleaseRule_update_DataChange_LastTime" BEFORE UPDATE ON apolloconfig."GrayReleaseRule" FOR EACH ROW EXECUTE PROCEDURE apolloconfig.update_modified_column();
...
CREATE TRIGGER "Instance_update_DataChange_LastTime" BEFORE UPDATE ON apolloconfig."Instance" FOR EACH ROW EXECUTE PROCEDURE apolloconfig.update_modified_column();
...
CREATE INDEX "InstanceConfig_IX_Valid_Namespace" ON apolloconfig."InstanceConfig" ("ConfigAppId","ConfigClusterName","ConfigNamespaceName","DataChange_LastTime");
CREATE TRIGGER "InstanceConfig_update_DataChange_LastTime" BEFORE UPDATE ON apolloconfig."InstanceConfig" FOR EACH ROW EXECUTE PROCEDURE apolloconfig.update_modified_column();
...
CREATE TRIGGER "Item_update_DataChange_LastTime" BEFORE UPDATE ON apolloconfig."Item" FOR EACH ROW EXECUTE PROCEDURE apolloconfig.update_modified_column();
...
CREATE TRIGGER "Namespace_update_DataChange_LastTime" BEFORE UPDATE ON apolloconfig."Namespace" FOR EACH ROW EXECUTE PROCEDURE apolloconfig.update_modified_column();
...
CREATE TABLE apolloconfig."NamespaceLock" (
  ...
  "DataChange_LastModifiedBy" varchar(64) DEFAULT '', -- COMMENT '最后修改人邮箱前缀'
  "DataChange_LastTime" timestamp NULL DEFAULT CURRENT_TIMESTAMP, -- COMMENT '最后修改时间'
  "IsDeleted" bit DEFAULT b'0', -- COMMENT '软删除'
  "DeletedAt" BIGINT NOT NULL DEFAULT '0', -- COMMENT 'Delete timestamp based on milliseconds'
...
CREATE TRIGGER "NamespaceLock_update_DataChange_LastTime" BEFORE UPDATE ON apolloconfig."NamespaceLock" FOR EACH ROW EXECUTE PROCEDURE apolloconfig.update_modified_column();
...
CREATE TABLE apolloconfig."Release" (
  ...
  "IsAbandoned" bit NOT NULL DEFAULT b'0', -- COMMENT '是否废弃'
  "IsDeleted" bit NOT NULL DEFAULT b'0', -- COMMENT '1: deleted, 0: normal'
  "DeletedAt" BIGINT NOT NULL DEFAULT '0', -- COMMENT 'Delete timestamp based on milliseconds'
  "DataChange_CreatedBy" varchar(64) NOT NULL DEFAULT 'default', -- COMMENT '创建人邮箱前缀'
  "DataChange_CreatedTime" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, -- COMMENT '创建时间'
...
CREATE TRIGGER "Release_update_DataChange_LastTime" BEFORE UPDATE ON apolloconfig."Release" FOR EACH ROW EXECUTE PROCEDURE apolloconfig.update_modified_column();
...
CREATE TRIGGER "ReleaseHistory_update_DataChange_LastTime" BEFORE UPDATE ON apolloconfig."ReleaseHistory" FOR EACH ROW EXECUTE PROCEDURE apolloconfig.update_modified_column();
...
CREATE TRIGGER "ReleaseMessage_update_DataChange_LastTime" BEFORE UPDATE ON apolloconfig."ReleaseMessage" FOR EACH ROW EXECUTE PROCEDURE apolloconfig.update_modified_column();
...
CREATE TRIGGER "ServerConfig_update_DataChange_LastTime" BEFORE UPDATE ON apolloconfig."ServerConfig" FOR EACH ROW EXECUTE PROCEDURE apolloconfig.update_modified_column();
...
CREATE TABLE apolloconfig."AccessKey" (
  ...
  "IsEnabled" bit NOT NULL DEFAULT b'0', -- COMMENT '1: enabled, 0: disabled'
  "IsDeleted" bit NOT NULL DEFAULT b'0', -- COMMENT '1: deleted, 0: normal'
  "DeletedAt" BIGINT NOT NULL DEFAULT '0', -- COMMENT 'Delete timestamp based on milliseconds'
  "DataChange_CreatedBy" varchar(64) NOT NULL DEFAULT 'default', -- COMMENT '创建人邮箱前缀'
  "DataChange_CreatedTime" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, -- COMMENT '创建时间'
...
CREATE TRIGGER "AccessKey_update_DataChange_LastTime" BEFORE UPDATE ON apolloconfig."AccessKey" FOR EACH ROW EXECUTE PROCEDURE apolloconfig.update_modified_column();
...
CREATE TRIGGER "ServiceRegistry_update_DataChange_LastTime" BEFORE UPDATE ON apolloconfig."ServiceRegistry" FOR EACH ROW EXECUTE PROCEDURE apolloconfig.update_modified_column();
