...
CREATE OR REPLACE FUNCTION apolloportal.update_modified_column() RETURNS TRIGGER AS $$
BEGIN
...
CREATE TRIGGER "App_update_DataChange_LastTime" BEFORE UPDATE ON apolloportal."App" FOR EACH ROW EXECUTE PROCEDURE apolloportal.update_modified_column();
...
CREATE TRIGGER "AppNamespace_update_DataChange_LastTime" BEFORE UPDATE ON apolloportal."AppNamespace" FOR EACH ROW EXECUTE PROCEDURE apolloportal.update_modified_column();
...
CREATE TRIGGER "Consumer_update_DataChange_LastTime" BEFORE UPDATE ON apolloportal."Consumer" FOR EACH ROW EXECUTE PROCEDURE apolloportal.update_modified_column();
...
CREATE TRIGGER "ConsumerAudit_update_DataChange_LastTime" BEFORE UPDATE ON apolloportal."ConsumerAudit" FOR EACH ROW EXECUTE PROCEDURE apolloportal.update_modified_column();
...
CREATE TRIGGER "ConsumerToken_update_DataChange_LastTime" BEFORE UPDATE ON apolloportal."ConsumerRole" FOR EACH ROW EXECUTE PROCEDURE apolloportal.update_modified_column();
...
CREATE TRIGGER "ConsumerToken_update_DataChange_LastTime" BEFORE UPDATE ON apolloportal."ConsumerToken" FOR EACH ROW EXECUTE PROCEDURE apolloportal.update_modified_column();
...
CREATE TRIGGER "Favorite_update_DataChange_LastTime" BEFORE UPDATE ON apolloportal."Favorite" FOR EACH ROW EXECUTE PROCEDURE apolloportal.update_modified_column();
...
CREATE TRIGGER "Permission_update_DataChange_LastTime" BEFORE UPDATE ON apolloportal."Permission" FOR EACH ROW EXECUTE PROCEDURE apolloportal.update_modified_column();
...
CREATE TRIGGER "Role_update_DataChange_LastTime" BEFORE UPDATE ON apolloportal."Role" FOR EACH ROW EXECUTE PROCEDURE apolloportal.update_modified_column();
...
CREATE TRIGGER "RolePermission_update_DataChange_LastTime" BEFORE UPDATE ON apolloportal."RolePermission" FOR EACH ROW EXECUTE PROCEDURE apolloportal.update_modified_column();
...
CREATE TRIGGER ServerConfig_update_DataChange_LastTime BEFORE UPDATE ON apolloportal."ServerConfig" FOR EACH ROW EXECUTE PROCEDURE apolloportal.update_modified_column();
...
CREATE TRIGGER "UserRole_update_DataChange_LastTime" BEFORE UPDATE ON apolloportal."UserRole" FOR EACH ROW EXECUTE PROCEDURE apolloportal.update_modified_column();
...
INSERT INTO apolloportal."Authorities" ("Username", "Authority") VALUES ('apollo', 'ROLE_user');
